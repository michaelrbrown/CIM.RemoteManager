...
{
    public class FindDevicesViewModel : BaseViewModel
    {
        ...
        public FindDevicesViewModel(IBluetoothLE bluetoothLe, IAdapter adapter, IUserDialogs userDialogs, ISettings settings, IPermissions permissions) : base(adapter)
        {
